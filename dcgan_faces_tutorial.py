...
plt.savefig('figures/Training-images.png')
...
plt.legend()
#plt.show()
plt.savefig('figures/Gen_Disc_Training_Loss.png)
...
ani.save('figures/Gen_training_progression.mp4')
#HTML(ani.to_jshtml())
...
plt.show()
plt.savefig('figures/fake_images_from_lat_epoch.png')
